...
lt_customers TYPE TABLE OF zrent_customer.
** BRANDS **
lt_brands = VALUE #(
...
modelo = 'GRAND CHEROKEE' color = 'BLANCO' motor ='3.6' potencia = '176' und_potencia = 'CV' combustible = 'GASOLINA' consumo = '12.00'
...
INSERT zrent_customer FROM TABLE @lt_customers.
SELECT * FROM zrent_customer INTO TABLE
@lt_customers.
out->write( sy-dbcnt ).
